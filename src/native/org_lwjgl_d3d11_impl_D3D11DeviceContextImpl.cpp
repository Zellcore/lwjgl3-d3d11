...
extern "C" {
    ...
    * Signature: (JJJ)V
    */
    JNIEXPORT void JNICALL Java_org_lwjgl_d3d11_impl_D3D11DeviceContextImpl_nClearRenderTargetView
    ...
    * Signature: (JIJJ)V
    */
    JNIEXPORT void JNICALL Java_org_lwjgl_d3d11_impl_D3D11DeviceContextImpl_nOMSetRenderTargets
    ...
    * Signature: (JIJ)V
    */
    JNIEXPORT void JNICALL Java_org_lwjgl_d3d11_impl_D3D11DeviceContextImpl_nRSSetViewports
